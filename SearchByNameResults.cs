...
namespace abn_service_client {
	...
	[XmlRoot (ElementName = "exception", Namespace = "http://abr.business.gov.au/ABRXMLSearch/")]
	public class ABRException {
		[XmlElement (ElementName = "exceptionDescription", Namespace = "http://abr.business.gov.au/ABRXMLSearch/")]
		public string ExceptionDescription { get; set; }

		[XmlElement (ElementName = "exceptionCode", Namespace = "http://abr.business.gov.au/ABRXMLSearch/")]
	...
	public class SearchByNameResponse {
		...
		[XmlElement (ElementName = "exception", Namespace = "http://abr.business.gov.au/ABRXMLSearch/")]
		public ABRException Exception { get; set; }
